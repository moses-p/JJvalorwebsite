  ...
  return (
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg text-gray-600 mb-8">Join our volunteer program and make a difference</p>
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-12 text-center">
          <p className="text-gray-600">Coming Soon - Volunteer application form</p>
        </div>
      </div>
    </div>
  );
